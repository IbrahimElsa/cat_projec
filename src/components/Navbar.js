...
const Navbar = () => {
return (
    <div className="bg-earthy-green text-soft-cream p-4 flex justify-between w-full">
        <div className='flex items-center'>
        <Link to="/" className="hover:text-white py-2 px-3">Home</Link>
        </div>
        <div className="flex space-x-4 ">
          {/* Cat Food & Nutrition Dropdown */}
        <div className="dropdown relative flex items-center space-x-4">
            <Link to="/cat-food-nutrition" className="hover:text-white py-2 px-3">
                Cat Food & Nutrition
            </Link>
            <div className="dropdown-menu absolute hidden hover:block bg-gray-700 text-white">
        ...
        <div className="dropdown relative flex items-center space-x-4">
            ...
            <div className="dropdown-menu absolute hidden bg-gray-700 text-white">
